            ...
            <div class="flex">
               <!-- Logo -->
                <div class="shrink-0 flex items-center">
                    <a href="#"><!--redirige al chat con la ia eso esta en el dashboard -->
                  ...
                  {{--   <x-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')">
                    ...
                    @auth
                        @if (auth()->user()->role === 'client')
                            <x-nav-link :href="route('user.show2')" :active="request()->routeIs('user.show2')">
                                {{ __('Mi rutina') }}
                            </x-nav-link>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
            ...
            <div class="mt-3 space-y-1">
                ...
                @auth
                    ...
                    @if (auth()->user()->role === 'client')
                        <x-responsive-nav-link :href="route('user.show2')" :active="request()->routeIs('user.show2')">
                            {{ __('Mi rutina') }}
                        </x-responsive-nav-link>
                    @endif
                @endauth
